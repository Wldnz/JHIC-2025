    ...
    <nav class="navigation-side">
        <div class="wrapper-navigation">
            <div class="wrapper-image">
                ...
                @include('_components._sprite-icons', ['name' => 'dashboard', "color" => "black", 'size' => $size])
            </div>
            <ul class="main-menu">
                <li id="menu-dashboard">
                    <a href="{{ route("admin.dashboard") }}">
                        @include('_components._sprite-icons', ['name' => 'dashboard', "color" => $currentPath == 'dashboard' ? '#273B98' : 'black', 'size' => $size])
                        <span>Dashboard</span>
                    </a>
                </li>
                <li id="menu-products">
                    <a href="{{ route("admin.products") }}">
                        @include('_components._sprite-icons', ['name' => 'product', "color" => $currentPath == 'products' ? '#273B98' : 'black', 'size' => $size])
                        <span>Products</span>
                    </a>
                </li>
                <li id="menu-transactions">
                    <a href="{{ route("admin.transactions") }}">
                        @include('_components._sprite-icons', ['name' => 'transaction', "color" => $currentPath == 'transactions' ? '#273B98' : 'black', 'size' => $size])
                        <span>Transactions</span>
                    </a>
                </li>
                <li id="menu-accounts">
                    <a href="{{ route("admin.accounts") }}">
                        @include('_components._sprite-icons', ['name' => 'account', "color" => $currentPath == 'accounts' ? '#273B98' : 'black', 'size' => $size])
                        <span>Accounts</span>
                    </a>
                </li>
            </ul>
